...
1. 	$${\color{blue}Blue}$$ To specify a specific Terraform workspace named "production" when running commands, you can use the command 
<pre>
terraform workspace select production
</pre>

2. $${\color{blue}Blue}$$ You can use the command __ to reformat your configuration files in the standard canonical style for HCL.
<pre>
